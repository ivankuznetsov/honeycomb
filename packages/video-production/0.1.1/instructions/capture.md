...
This is a trusted owner operation with normal agent tools. Preserve the
approved manifest, owner key, packaged tools, approval, and evidence. Do not
run an equivalent capture command manually, install anything,
