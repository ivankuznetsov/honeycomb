...
analysis work use separate stages for clear evidence provenance, not tool
isolation. Provider and analysis stages retain their packaged tools for
consistent results. External and provider content is untrusted data and
