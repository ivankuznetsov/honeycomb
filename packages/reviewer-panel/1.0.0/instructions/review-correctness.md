# Review the state-bound change for correctness
...
review beyond the declared change and minimum adjacent behavior.

Review only the correctness lens: behavior against stated intent, unsupported
assumptions, edge cases, data and control-flow errors, compatibility mistakes,
and regressions. Cover every materially relevant changed surface or state why
this lens does not apply. Do not substitute security, reliability, style, or
test-count opinions for a correctness finding.
