...
After the architecture writer completes, Hive advances the task from
`7-architecture` to the inert `8-done` stage. `architecture.md` remains the
final document; no additional agent runs in Done.
