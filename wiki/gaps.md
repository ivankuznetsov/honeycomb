...
| Lifecycle rollout | Durable state preservation is enforced by the exporter, but the protected normalized-evidence path and emergency transition procedure have not been canaried on the live repository. | Task 1851 must choose the checked-in/protected evidence location; then exercise soft-hide, yank, revoke, and relist without losing history. |
